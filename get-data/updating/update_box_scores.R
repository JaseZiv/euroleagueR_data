...
existing_team_box <- readRDS(url(paste0("https://github.com/JaseZiv/euroleagueR_data/releases/download/box_scores/team_box_", gsub("E", "", current_season), ".rds")))
existing_player_box <- readRDS(url(paste0("https://github.com/JaseZiv/euroleagueR_data/releases/download/box_scores/player_box_", gsub("E", "", current_season), ".rds")))
